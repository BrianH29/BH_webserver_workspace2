 ...
 * Generated at: 2020-09-23 07:06:44 UTC
...
if(loginUser == null){ // 로그인전 
      ...
      out.write("\t\t\t\t\t\t\t<textarea cols=\"60\" row=\"3\" style=\"resize: none\" readonly>로그인 후 이용가능한 서비스입니다.</textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t");
}else{ // 로그인 후
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<textarea id=\"replyContent\" cols=\"50\" row=\"3\" style=\"resize: none\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<button onclick=\"addReply();\">댓글등록</button>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t");
} 
      out.write("\r\n");
      ...
      out.write("\t\t\t<script>\r\n");
      out.write("\t\t\t\t$(function(){\r\n");
      out.write("\t\t\t\t\tselectReplyList(); // 페이지 로딩 된 직후에 이 게시글에 딸려있는 댓글리스트 조회 \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tsetInterval(selectReplyList, 1000); // 실시간으로 댓글 달아 놓은걸 볼 수 있다. \r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//해당 게시글에 댓글 작성용 ajax\r\n");
      ...
      out.write("\t\t\t\t\t\t\tconsole.log(\"댓글 작성용 ajax 실패\")\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//해당 게시글에 딸려있는 뎃글리스트 조회용 ajax\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\"</tr>\";\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#replyArea>table>tbody\").html(result); \r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\terror:function(){\r\n");
      out.write("\t\t\t\t\t\t\tconsole.log(\"댓글 리스트 조회요 ajax통신 실패\")\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t}\r\n");
