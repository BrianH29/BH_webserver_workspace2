 ...
 * Generated at: 2020-09-14 02:27:03 UTC
...
public final class noticeListView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t<!-- 리스타가 비어있을 경우 -->\r\n");
      out.write("\t\t\t");
if(list.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">존재하는 공지사항 없습니다.</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
} else { 
      out.write("\r\n");
      out.write("\t\t\t<!-- 리스타가 비어있지 않을 경우 -->\r\n");
      out.write("\t\t\t\t");
 for(Notice n : list){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\".listArea>tbody>tr\").click(function(){ //학습동영상 Server33_jspProject18 9월8일 \r\n");
      out.write("\t\t\t\t//console.log(\"클릭클릭클릭\");\r\n");
